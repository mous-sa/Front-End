...
/*var tableau=[] ;
var saisie = "" ;
  var tailletableau= (prompt ("saisir taille tableau" )); 
for (i=0 ; i<tailletableau;i++)
{
  saisie = prompt ("veullez saisir une valeur") ; 
tableau.push(saisie) ;
}
console.log (tableau) ;*/
/*###############################################################Exercice 2 du js08###################################################*/
...
var tabl=[] ;
tabl[0]=["poireau" , "peche","abricot"] ;
tabl[1]=["fraise","poire" , "abre"] ;
console.log(tabl[1] [2]) ;"""2